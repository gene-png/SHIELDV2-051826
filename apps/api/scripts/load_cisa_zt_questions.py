"""Load CISA ZTMM 2.0 questionnaire into `questions`.

Source: packages/zt-data/cisa_questions.json (extracted from the locked
reference questionnaire at reference-docs/SHIELDv2_CISA_ZT_Questionnaire.docx).
...
LOADER = "cisa_zt_questions"
SOURCE = PACKAGES / "zt-data" / "cisa_questions.json"
